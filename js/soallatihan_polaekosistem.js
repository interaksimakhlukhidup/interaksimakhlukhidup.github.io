...
function nomor2(){
	...
	if(nilai==1){
		...
		jumlah_benar=jumlah_benar+1;
		form.no2[0].parentElement.style.backgroundColor ='green';
...
function cek(){
	if( form.no1.value === ""|| form.no2.value === ""  || form.no3.value === "" ){
		...
		if(jumlah_benar>=3){
			sessionStorage.setItem("tombol_lanjut_polaekosistem", '1');
			localStorage.setItem("tombol_lanjut_polaekosistem", '1');
