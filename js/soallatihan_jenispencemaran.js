...
function nomor1(){
	...
	if(nilai==2){
		...
		form.no1[1].parentElement.style.backgroundColor ='green';
...
function nomor3(){
	...
	if(nilai==4){
		...
		jumlah_benar=jumlah_benar+1;
		form.no3[3].parentElement.style.backgroundColor ='green';
...
function cek(){
	if( form.no1.value === ""|| form.no2.value === ""  || form.no3.value === "" ){
		...
		if(jumlah_benar>=3){
			sessionStorage.setItem("tombol_lanjut_jenispencemaran", '1');
			localStorage.setItem("tombol_lanjut_jenispencemaran", '1');
