...
function nomor1(){
	...
	if(nilai==3){
		...
		form.no1[2].parentElement.style.backgroundColor ='green';
...
function nomor2(){
	...
	if(nilai==3){
		...
		jumlah_benar=jumlah_benar+1;
		form.no2[2].parentElement.style.backgroundColor ='green';
		...
		form.no2[3].parentElement.style.backgroundColor ='white';
			...
			form.no2[3].parentElement.style.backgroundColor ='red';
			form.no2[0].parentElement.style.backgroundColor ='white';
			form.no2[1].parentElement.style.backgroundColor ='white';
			form.no2[2].parentElement.style.backgroundColor ='white';
			document.getElementById("ket2").innerHTML ="Jawaban Salah";
...
function nomor3(){
	...
	if(nilai==1){
		...
		jumlah_benar=jumlah_benar+1;
		form.no3[0].parentElement.style.backgroundColor ='green';
...
function cek(){
	if( form.no1.value === ""|| form.no2.value === ""  || form.no3.value === "" ){
		...
		if(jumlah_benar>=3){
			sessionStorage.setItem("tombol_lanjut_pengertianpencemaran", '1');
			localStorage.setItem('tombol_lanjut_pengertianpencemaran',1);
